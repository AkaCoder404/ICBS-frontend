...
const TabsControl = tw.div`flex flex-wrap bg-gray-200 px-2 py-2 rounded leading-none mt-12 xl:mt-0 xl:w-1/3`;

const TabControl = styled.div`
  ${tw`cursor-pointer px-6 py-3 mt-2 sm:mt-0 sm:mr-2 last:mr-0 text-gray-600 font-medium rounded-sm transition duration-300 text-sm sm:text-base w-1/2 sm:w-32 text-center`}
  &:hover {
...
export default ({
  heading = "Academic report Schedule",
  tabs = {
    "27th June": [
      {
    ...
    "28th June": getRandomCards(),
    "29th June": getRandomCards()
  }
}) => {
  /*
